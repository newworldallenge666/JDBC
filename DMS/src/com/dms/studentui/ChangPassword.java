...
public class ChangPassword extends JPanel {
	/**
	 * 改变密码界面板块
	 */
	...
	public ChangPassword(Student stu) {
		this.student = stu;
		setSize(800,600);
        setLayout(null);
        	...
        	public void actionPerformed(ActionEvent arg0) {
        		...
        		if(oldpwd.equals("")||newpwd.equals("")||checknewpwd.equals(""))
	        		...
	        		if(updatePasswordInfo.getnewPwd().equals(updatePasswordInfo.getCheckNewPwd())){
	        			try {
							student.PasswordUpdate(updatePasswordInfo);
